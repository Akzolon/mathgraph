...
For a comprehensive list of features, visit the [features page](./features/). You can read more about the _why_ behind these features on the [[mathgraph/docs/philosophy]] page and a technical overview on the [[architecture]] page.
